...
describe('Create Session Page Authentication Flow', () => {
  ...
  it('should show sign-in prompt for unauthenticated users', () => {
    ...
    expect(screen.getByText('Please sign in with Google to create a Q&A session')).toBeInTheDocument()
  ...
  it('should show create session form for authenticated users', () => {
    ...
    expect(screen.getByText('Set up a Q&A session for your event or meeting')).toBeInTheDocument()
    expect(screen.getByPlaceholderText('e.g., Weekly Team Meeting Q&A')).toBeInTheDocument()
  ...
  it('should display user information when authenticated', () => {
    ...
    expect(screen.getByAltText('Profile')).toHaveAttribute('src', 'https://example.com/jane-avatar.jpg')
